...
:::{.column-margin}
Sometimes you will see that the objective being written as a sum, instead of an average. The $ \frac{1}{n}$ normalizing constant in this "sum" convetion is getting "absorbed" into individual $f_i$.
$$
