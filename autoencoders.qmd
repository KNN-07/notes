...
The inner product indicates how aligned two vectors are: highly positive values imply strong similarity, negative values indicate opposition, and values near zero suggest no similarity.
...
The idea of good embeddings will play a central role when we discuss attention mechanisms in @sec-transformers, 
