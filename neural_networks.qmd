:::{.callout-note}
This page contains all content from the legacy [PDF notes](https://introml.mit.edu/_static/spring25/notes.pdf);  neural networks chapter.
...
by Sebastian Ruder's excellent blog posts on the topic:{ruder.io/optimizing-gradient-descent}
:::
