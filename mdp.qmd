...
$$
\mathrm{V}^1_{\pi}(s) = R(s, \pi_1(s)) + 0
$${#eq-finite_val_1}

$$
\mathrm{V}^2_{\pi}(s) = R(s, \pi_2(s)) +  \gamma \sum_{s'}\mathrm{T}(s, \pi_2(s), s')  \mathrm{V}^1_{\pi}(s')
$${#eq-finite_val_2}
...
$$
\mathrm{V}^h_{\pi}(s) = R(s, \pi_h(s)) + \gamma \sum_{s'}\mathrm{T}(s, \pi_h(s), s')  \mathrm{V}^{h - 1}_{\pi}(s')
$${#eq-finite_value}
...
$$
\mathrm{V}_{\pi}(s) = \mathbb{E}[R_0 + \gamma R_1 + \gamma^2 R_2 +
...
$$\begin{aligned}
  \mathrm{V}_{\pi}(s) & = \mathbb{E}[R_0 \mid \pi, S_0 = s] + \gamma  \mathbb{E}[
    R_1 + \gamma(R_2 + \gamma \dots))) \mid \pi, S_0 = s]
  \nonumber
  \\
             & = R(s, \pi(s)) + \gamma\sum_{s'}\mathrm{T}(s, \pi(s), s')\mathrm{V}_{\pi}(s') \; .
\end{aligned}
$${#eq-inf_horiz_value}
...
$$\begin{aligned}
  \mathrm{Q}^0(s, a) & = 0                                                                 \\
  \mathrm{Q}^1(s, a) & = R(s, a) + 0                                                       \\
  \mathrm{Q}^2(s, a) & = R(s, a) + \gamma \sum_{s'}\mathrm{T}(s, a, s') \max_{a'} \mathrm{Q}^1(s', a')       \\
  \vdots
  \nonumber                                                                       \\
  \mathrm{Q}^h(s, a) & = R(s, a) + \gamma \sum_{s'}\mathrm{T}(s, a, s') \max_{a'} \mathrm{Q}^{h - 1}(s', a')
\end{aligned}
$$ 
...
$$\mathrm{Q}(s, a) = R(s, a) + \gamma\sum_{s'}\mathrm{T}(s, a, s')\max_{a'}\mathrm{Q}(s', a') \;\;.$$
