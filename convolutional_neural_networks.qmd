...
![The "depth" dimension in the layers shown as cuboids corresponds to the number of channels in the output tensor. (Figure source: Mathworks)](figures/cnn.jpg){width=80%}
