...
We are standardizing to "each row as a data point." Thus, $X$ in assignments aligns with $\tilde{X}$ in the PDF notes if you've read those. If you spot inconsistencies or experience any confusion, please raise an issue. Thanks!
:::
