...
$$\begin{aligned}
\theta_{aug}^*&=\left ( \begin{bmatrix} X^T\\\mathbb{1}^T\end{bmatrix}\begin{bmatrix}X&\mathbb{1}\end{bmatrix}\right)^{-1}\begin{bmatrix}X^T\mathbb{1}^T\end{bmatrix}Y\\
&=\begin{bmatrix}X^TX&X^T\mathbb{1}\\\mathbb{1}^TX&\mathbb{1}^T\mathbb{1}\end{bmatrix}\begin{bmatrix}X^T\\\mathbb{1}^T\end{bmatrix}Y\\
&=\begin{bmatrix}X^TX&X^T\mathbb{1}\\\mathbb{1}^TX&\mathbb{1}^T\mathbb{1}\end{bmatrix}\begin{bmatrix}X^T\\\mathbb{1}^T\end{bmatrix}Y\\
&=\begin{bmatrix}X^TX&0\\0&n\end{bmatrix}\begin{bmatrix}X^T\\\mathbb{1}^T\end{bmatrix}Y\\
&=\begin{bmatrix}(X^TX)^{-1}X^TY\\n\mathbb{1}^TY\end{bmatrix}=\begin{bmatrix}(X^TX)^{-1}X^TY\\0\end{bmatrix}\\
