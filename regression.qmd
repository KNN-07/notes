...
Given a training set ${\cal D}_n$ and a hypothesis $h$ with parameters $\Theta,$ we can define the *training error* of $h$ to be the average loss on the training data: 
