...
:::{.column-margin}
See @sec-matrix-derivative if you need some help finding this derivative.
:::

Setting this equal to zero and solving for $\theta$ yields the final closed for solution:
...
Now, how do we deal with the offset? We augment the original feature vector with a "fake" feature of value 1, and add a corresponding parameter $\theta_0$ to the $\theta$ vector. This is equivalent to adding a constant term to the hypothesis, and we can now write the hypothesis as
